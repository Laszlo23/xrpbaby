  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%,100%": { opacity: "0.4", transform: "scale(1)" }, "50%": { opacity: "1", transform: "scale(1.08)" } },
        ...
        "particle": { "0%": { transform: "translateY(0) translateX(0)", opacity: "0" }, "10%": { opacity: "0.8" }, "100%": { transform: "translateY(-100vh) translateX(40px)", opacity: "0" } },
      },
      animation: {
