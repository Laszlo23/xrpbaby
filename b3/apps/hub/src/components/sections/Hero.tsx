      ...
      <motion.div style={{ opacity }} className="relative z-10 flex h-full flex-col items-start justify-center px-6 md:px-16 lg:px-24">
        ...
        >
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <p className="w-full font-mono text-[10px] uppercase tracking-[0.35em] text-muted-foreground">
              build the community
            </p>
            <a
              ...
              className="inline-flex items-center justify-center rounded-full border border-border/60 bg-background/30 px-5 py-3 font-mono text-[10px] uppercase tracking-[0.28em] text-foreground backdrop-blur transition-all duration-500 hover:border-primary/60 hover:text-foreground"
            >
              follow on X
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center rounded-full border border-border/60 bg-background/30 px-5 py-3 font-mono text-[10px] uppercase tracking-[0.28em] text-foreground backdrop-blur transition-all duration-500 hover:border-secondary-glow/60 hover:text-foreground"
            >
              join Telegram
            </a>
          </div>
