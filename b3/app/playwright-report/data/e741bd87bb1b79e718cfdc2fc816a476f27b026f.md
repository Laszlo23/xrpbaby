...
- Name: identity-resolve.spec.ts >> culture name resolution >> gateway redirects to profile
- Location: e2e/identity-resolve.spec.ts:4:3
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e5]:
      ...
      - heading "testname.culture" [level=1] [ref=e8]:
        - text: testname
      ...
      - link "Mint this name →" [ref=e11] [cursor=pointer]:
        - /url: /pass?name=testname&tld=.culture
    - contentinfo [ref=e12]:
      - generic [ref=e13]:
        - generic [ref=e14]:
          - generic [ref=e15]:
