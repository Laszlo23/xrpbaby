    ...
    >
      <div className="grid gap-4">
        <section className="rounded-3xl border border-cyan-500/20 bg-cyan-500/5 p-6 space-y-3">
          ...
          <ul className="space-y-2 text-sm text-zinc-300">
            <li className="flex gap-2">
              ...
              <span>
                <strong className="text-zinc-100">Rentable by design</strong> — other agents pay x402 per
                quote; revenue settles to your treasury on Base.
              </span>
            </li>
            <li className="flex gap-2">
            ...
            <li className="flex gap-2">
              ...
              <span>
                <strong className="text-zinc-100">No custody</strong> — swap previews return unsigned txs;
                BCDAI or Privy signs client-side.
              </span>
            </li>
            <li className="flex gap-2">
              <Coins className="h-4 w-4 shrink-0 text-cyan-400" />
              <span>
                <strong className="text-zinc-100">BCC-native path</strong> — ETH→BCC quotes on Aerodrome, same
                token as the culture economy.
              </span>
            </li>
          </ul>
        </section>
        ...
        <section className="rounded-3xl border border-white/[0.08] bg-white/[0.03] p-6">
          <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-zinc-500">SKUs (x402)</p>
          <ul className="mt-3 space-y-2 font-mono text-xs text-zinc-300">
            ...
            <li>
              Swap preview — <span className="text-zinc-100">GET /api/trading/swap-preview</span> — default
              $0.15 (unsigned calldata)
            </li>
        ...
        <section className="rounded-3xl border border-white/[0.08] bg-white/[0.02] p-6 text-sm text-zinc-400">
          <p>
            BCDAI and internal fleet agents should call the <strong className="text-zinc-200">platform URLs</strong>{" "}
            above (not the raw Python port) so payments and attribution stay on BUILDCHAIN. Operators run{" "}
