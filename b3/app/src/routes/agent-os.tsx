  ...
  return (
    ...
    >
      <div className="flex flex-col gap-12 md:gap-14">
        <SectionErrorBoundary label="Agent OS">
          ...
          {overview ? (
            ...
            <aside className="rounded-2xl border border-amber-500/25 bg-amber-500/[0.06] px-5 py-4 text-sm text-amber-100/90">
              Live agent stats are temporarily unavailable. Research and grant panels below may
              still work with direct payment.
            </aside>
          )}
            ...
            <ul className="grid gap-3 sm:grid-cols-2 text-sm text-zinc-400">
              ...
              <li className="rounded-xl border border-white/[0.06] px-4 py-3">
                ...
                <p className="mt-1 text-xs">
                  Non-custodial USDC wallet on Base — pay or scan to fund Limx
                </p>
              </li>
              <li className="rounded-xl border border-white/[0.06] px-4 py-3">
