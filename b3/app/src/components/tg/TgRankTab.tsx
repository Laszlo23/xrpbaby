    ...
    <div className="space-y-4">
      <div className="rounded-2xl border border-[#C5FF41]/20 bg-[#141810] p-4 text-center">
        ...
        {data.you.xpBehindNext != null && data.you.xpBehindNext > 0 ? (
          <p className="mt-1 text-xs text-zinc-500">{data.you.xpBehindNext} XP behind the next spot</p>
        ) : null}
      </div>
          ...
          {data.rows.map((row) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                {row.isYou ? (
                  <span className="text-[10px] text-[#C5FF41]">you</span>
                ) : null}
              </div>
