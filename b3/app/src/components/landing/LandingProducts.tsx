...
import { PILLAR_PRODUCTS } from "@/lib/landing-copy";
    ...
    <section id="products" className="relative w-full overflow-hidden bg-[#050505] py-28 sm:py-36">
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
        <div className="max-w-3xl">
          <p className="mono-label">CORE PRODUCTS</p>
          <motion.h2
          ...
          >
            The community OS — <br />
            <span className="text-zinc-500">four pillars.</span>
          </motion.h2>
          <p className="mt-6 max-w-xl text-base text-zinc-400 sm:text-lg">
            Culture ID, campaigns, Agent OS, and BCC — the core stack. Everything else in the
            ecosystem extends these pillars.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 gap-5 md:grid-cols-2">
          {PILLAR_PRODUCTS.map((product, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="group relative overflow-hidden rounded-3xl bc-glass p-7 transition-all hover:bc-glass-strong sm:p-8"
            >
