...
export const plainLabels = {
  ...
  join: {
    ...
    subtitle: "One tap to join Building Culture — then pick your path and enter the hub.",
    finishTitle: "Almost there",
    finishSubtitle: "Choose what brought you here, sign once, and we will open your dashboard.",
    ...
    connectSubtitle: "Email, Base Account, Coinbase, or any wallet on Base.",
    moreWallets: "More wallets (MetaMask, WalletConnect…)",
    openingWallet: "Opening…",
    loadingWallet: "Loading wallet options…",
    redirecting: "Opening your hub…",
    stepConnect: "Connect",
    stepPath: "Your path",
    stepHub: "Hub",
