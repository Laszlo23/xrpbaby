...
export const PRIMARY_STARTER_APPS: LandingEcosystemApp[] = [
  ...
  },
  {
    ...
    name: "Campaign Hub",
    description:
      "Participate in fair drops, grants, and community campaigns — earned access after Culture ID and credentials.",
    tag: "Access",
    status: "live",
    layer: "access",
    href: "/play",
...
/** In-app links formerly in mega-footer — full directory on /ecosystem. */
export const ECOSYSTEM_DIRECTORY_EXTRAS: LandingEcosystemApp[] = [
  {
    id: "bc-forest",
    name: "Community Hub (Forest)",
    description: "Quests, points, and community participation.",
    tag: "Community",
    status: "live",
    layer: "community",
    href: "/forest",
  ...
  {
    id: "bc-join",
    name: "Join Building Culture",
    description: "Onboarding and welcome rewards.",
    tag: "Community",
    status: "live",
    layer: "community",
    href: "/join",
  },
  {
    id: "bc-explorer",
    name: "Explorer",
    description: "Human-readable onchain activity.",
    tag: "Platform",
    status: "live",
    layer: "platform",
    href: "/explorer",
  },
  {
    id: "bc-collections",
    name: "Collections",
    description: "Curated NFT and culture collections.",
    tag: "Platform",
    status: "live",
    layer: "platform",
    href: "/collections",
  },
  {
    id: "bc-voice",
    name: "Builder Voice",
    description: "Voice notes and builder chronicle.",
    tag: "Community",
    status: "live",
    layer: "community",
    href: "/voice",
  },
  {
    id: "bc-elias",
    name: "Elias",
    description: "AI coach and onboarding orb.",
    tag: "AI",
    status: "live",
    layer: "ai",
    href: "/elias",
  },
  {
    id: "bc-creators",
    name: "Creators",
    description: "Creator economy hub and tools.",
    tag: "Economy",
    status: "live",
    layer: "economy",
    href: "/creators",
  },
  {
    id: "bc-earth",
    name: "Earth",
    description: "Impact and environmental lane.",
    tag: "Impact",
    status: "live",
    layer: "impact",
    href: "/earth",
  ...
  {
    id: "bc-trading-agent",
    name: "Trading Agent (x402)",
    description: "Premium market data via x402 payments.",
    tag: "AI",
    status: "live",
    layer: "ai",
    href: "/trading-agent",
  },
  {
    id: "bc-agent-shares",
    name: "Agent Shares",
    description: "Campaign and agent share fleet.",
    tag: "Capital",
    status: "live",
    layer: "capital",
    href: "/campaign",
  },
  {
    id: "bc-signal",
    name: "Culture Pulse",
    description: "Growth metrics and social attestation.",
    tag: "Live signal",
    status: "live",
    layer: "core",
    href: "/signal",
