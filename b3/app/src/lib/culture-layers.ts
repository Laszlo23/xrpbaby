  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        id: "culture-score",
        label: "Culture Score",
        description: "Weighted reputation across social, links, onchain, and ecosystem signals.",
        href: "/id/laszlo.culture",
      },
      {
        id: "badges",
        label: "Badges",
        description: "Culture Points, reward grants, and founding keys in the forest.",
        href: "/forest",
      },
      {
        id: "reputation",
        label: "Reputation",
        description: "Unified identity graph — ENS, Farcaster, Lens, and more.",
        href: "#culture-identity-graph",
      },
    ],
  },
  {
