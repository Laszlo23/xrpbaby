...
const FALLBACK_PROJECTS = [
  ...
  { id: "bc-home", name: "BC Home", tag: "Living", layer: "living", status: "beta", url: "https://home.buildingculture.capital" },
...
const OrbitIcon = ({ project, baseAngle, radius, ringRotation }) => {
  ...
  const href = project.url || "#ecosystem";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className="absolute -right-0.5 -top-0.5 h-2 w-2 rounded-full ring-2 ring-[#070707]"
          style={{ background: statusColor }}
          aria-hidden
        />
        <span className="pointer-events-none absolute bottom-full left-1/2 z-20 mb-2 -translate-x-1/2 whitespace-nowrap rounded-md border border-white/10 bg-black/90 px-2 py-1 text-[10px] font-medium text-white opacity-0 shadow-lg transition-opacity duration-200 group-hover:opacity-100 sm:text-[11px]">
          {project.name}
        </span>
      </motion.a>
    </motion.div>
...
const OrbitRing = ({ projects, radius, duration, reverse }) => {
...
export const BCD = () => {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[700px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#00E5FF]/15 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-5 text-center sm:px-8">
        ...
        <div className="relative mx-auto mt-16 flex items-center justify-center sm:mt-20">
          ...
          >
            ...
            />
            <div
              className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-dashed border-white/12"
        ...
        <p className="mt-10 font-mono text-[11px] uppercase tracking-[0.2em] text-zinc-500 sm:mt-14">
