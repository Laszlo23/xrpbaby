...
/// @title GroveTwinBloomVoucher
/// @notice Owner-minted ERC-721 audio NFT for Culture Grove Twin Bloom (2 direct invites).
contract GroveTwinBloomVoucher is ERC721, Ownable {
    ...
    function mintVoucher(address to, bytes32 claimDigest) external onlyOwner returns (uint256 tokenId) {
        ...
        emit GroveTwinBloomMinted(to, tokenId, claimDigest);
    }
