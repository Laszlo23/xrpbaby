...
import { planOrchestration } from "@/lib/bcd-agent-orchestration";
      ...
      <div className="flex flex-col gap-12 md:gap-14">
        ...
        <section className="rounded-3xl border border-white/[0.08] bg-white/[0.02] p-6 md:p-8">
          ...
          <ol className="mt-4 list-inside list-decimal space-y-2 text-sm text-zinc-400 marker:text-zinc-600">
            ...
            <li>
              Move BCD / ETH only through treasury policy — extend `bcd-agent-orchestration.ts` on
              the server with real queues.
            </li>
          </ol>
        </section>
